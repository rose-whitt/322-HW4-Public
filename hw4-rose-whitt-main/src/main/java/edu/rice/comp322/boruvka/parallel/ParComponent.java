...
public final class ParComponent extends Component<ParComponent> {
    ...
    public final int nodeId; /* Identifier for this component. */

    /* Reentrant lock for parallel computation implementation */
    public final Lock lock = new ReentrantLock();

    public List<Edge<ParComponent>> pq = new ArrayList<>(); /* List of edges. */
    public double totalWeight = 0; /* Weight of current component; Gains weight through merging. */
    public long totalEdges = 0; /* Number of edges collapsed to create current component. */
    public boolean isDead = false; /* Indicates if component has already been collapsed. */
